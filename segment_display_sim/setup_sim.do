    set sopc "e:/applications/altera/12/quartus//sopc_builder"
    set sopc_perl "e:/applications/altera/12/quartus//bin/perl"
...
if { [ string match "*ModelSim ALTERA*" [ vsim -version ] ] } {
 alias _init_setup {vlib work
                       ...
                       vcom -93 -explicit e:/applications/altera/12/quartus/libraries/vhdl/altera/altera_europa_support_lib.vhd
		       } } else {
 alias _init_setup {vlib work
                       vmap altera               work
                       vmap arriaii_hssi         work
                       ...
                       vcom -93 -explicit e:/applications/altera/12/quartus/libraries/vhdl/altera/altera_europa_support_lib.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/altera_mf_components.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/altera_mf.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/220pack.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/220model.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/sgate_pack.vhd
                       vcom -93 -explicit e:/applications/altera/12/quartus/eda/sim_lib/sgate.vhd
                       } } 
...
alias s "_init_setup
vcom -93 -explicit C:/ECT363/Lab4/timer_0.vhd
vcom -93 -explicit C:/ECT363/Lab4/sysid.vhd
vcom -93 -explicit C:/ECT363/Lab4/led_pio.vhd
vcom -93 -explicit C:/ECT363/Lab4/jtag_uart_0.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_test_bench.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_mult_cell.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_oci_test_bench.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_jtag_debug_module_tck.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_jtag_debug_module_sysclk.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0_jtag_debug_module_wrapper.vhd
vcom -93 -explicit C:/ECT363/Lab4/cpu_0.vho
vcom -93 -explicit C:/ECT363/Lab4/onchip_memory2_0.vhd
vcom -93 -explicit C:/ECT363/Lab4/seven_seg_pio.vhd
vcom -93 -explicit C:/ECT363/Lab4/segment_display.vhd
_vsim
do virtuals.do
set StdArithNoWarnings 1
; test_contents_files"
alias r "exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./segment_display_generation_script  } "
alias c "echo {Regenerating memory contents.
 (This may take a moment)...}; restart -f; exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./segment_display_generation_script  }  --software_only=1"
...
proc s_cycloneiv {} {
  if { [ expr ! [ string match "*ModelSim ALTERA*" [ vsim -version ] ] ] } {
    vlib work
    _init_setup
    set qsimlib e:/applications/altera/12/quartus/eda/sim_lib
    set vhd_files [ list \
